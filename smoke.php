    ...
    if($_GET["action"] == "delete")
    {
        foreach($_SESSION["smoke_cart"] as $keys => $values)
        {
            if($values["item_id"] == $_GET["id"])
            {
                ...
                echo '<script>window.location="smoke.php"</script>';
            }
        }
    }
}
...
<html>
    <head>
        ...
        <title>AhmadBakkar | CigarettesPage</title>
    ...
    <div class="container">
		<div class="placeholder">
			<div class="parallax-window" data-parallax="scroll" data-image-src="img/tobacco1.webp">
				<div class="tm-header">
        ...
        <div class="row tm-gallery">
			<div id="tm-gallery-page-pizza" class="tm-gallery-page">
                <?php
					$query = "SELECT * FROM smokeproducts ORDER BY id ASC";
					...
					if(mysqli_num_rows($result) > 0)
					{
                    	...
                    	{
                ?>
				<form method="post" action="smoke.php?action=add&id=<?php echo $row["id"]; ?>">
			    	<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
			    		<img src="<?php echo $row['ImageSrc']; ?>" alt="Image" class="img-fluid    tm-gallery-img" style="width: 200px; height: 200px;"/>
						<figcaption>
							...
							Qnt: <input type="number" value="1" name="quantity" style="width: 45px;"> 	
