    ...
    <div class="container">
        ...
        <div class="row tm-gallery">
			<div id="tm-gallery-page-pizza" class="tm-gallery-page">
                <?php
					$query = "SELECT * FROM allproducts ORDER BY id ASC";
					...
					if(mysqli_num_rows($result) > 0)
					{
                    	...
                    	{
                ?>
				<form method="post" action="allProducts.php?action=add&id=<?php echo $row["id"]; ?>">
			    	<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
			    		<img src="<?php echo $row['ImageScr']; ?>" class="img-fluid tm-gallery-img" style="width: 200px; height: 200px;"/>
			    		<figcaption>
